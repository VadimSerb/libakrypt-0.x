...
/* ----------------------------------------------------------------------------------------------- */
/*! \brief Непосредственно функция хэширования, которая записывает в sha.res итоговый блок, из     
  которого вычленяется итоговый хэш нужной длины                                                   */
/* ----------------------------------------------------------------------------------------------- */
int ak_sha3_function(ak_keccak sha, ak_uint8 answer[]) {
    ...
    switch ( sha.ftype ) {    //Инициализация нужной функции хэширования: SHA-224, 256, 384, 512?
    case 512:
    ...
    //После инициализации параметров нужной функции хэширования выполняется Keccak
    while(N > 0) {
    ...
    //Запись итогового хэша в массив байтов для дальнейшей работы с ним при необходимости
...
/*! \brief Константы-ответы для проведения тестирования работоспособности SHA-512, 384, 256, 224.
  Первые два массива с хэшем - примеры из Википедии, третий - опубликованный NIST, четвертый -
  сгенерирован вручную с онлайн сервиса                                                         */

//--------------------------------------SHA-512-------------------------------------------------
const static ak_uint8 lazy_dog_512[64] = {
...
const static ak_uint8 lazy_dog_512_point[64] = {
...
const static ak_uint8 nist1600_512[64] = {
...
const static ak_uint8 online_512[64] = {
...
//--------------------------------------SHA-384-------------------------------------------------
const static ak_uint8 lazy_dog_384[48] = {
...
const static ak_uint8 lazy_dog_384_point[48] = {
...
const static ak_uint8 nist1600_384[48] = {
...
const static ak_uint8 online_384[48] = {
...
//--------------------------------------SHA-256-------------------------------------------------
const static ak_uint8 lazy_dog_256[32] = {
...
const static ak_uint8 lazy_dog_256_point[32] = {
...
const static ak_uint8 nist1600_256[32] = {
...
const static ak_uint8 online_256[32] = {
...
//--------------------------------------SHA-224-------------------------------------------------
const static ak_uint8 lazy_dog_224[28] = {
...
const static ak_uint8 lazy_dog_224_point[28] = {
...
const static ak_uint8 nist1600_224[28] = {
...
const static ak_uint8 online_224[28] = {
...
/* ----------------------------------------------------------------------------------------------- */
/*! \brief Мини-функция для проведения тестов. Сравнивает получившийся хэш-массив с хэш-ответом    */
/* ----------------------------------------------------------------------------------------------- */
...
/* ----------------------------------------------------------------------------------------------- */
/*! \brief Тестирование работоспособности функций хэширования SHA-512, SHA-384, SHA-256, SHA-224   */
/* ----------------------------------------------------------------------------------------------- */
int ak_sha3_tests() {
    ...
    //Соответсвенный выбор нужной функции хэширования на сайте
